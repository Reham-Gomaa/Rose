...
@Component({
  selector: 'app-home',
  imports: [CommonModule, CategoriesComponent, GiftsComponent, OurServicesComponent, BestSellerComponent, PopularItemsComponent, AboutUsComponent, GalleryComponent, TestimonialsComponent, TrustedByComponent],
