...
@Component({
  ...
  imports: [EnglishOnlyDirective, SortingComponent, InputBtnComponent, TranslatePipe, FilterOccasionsComponent, FilterPriceComponent, FilterSalesComponent, FilterRatingComponent, FilterCardComponent, FilterCategoryComponent],
