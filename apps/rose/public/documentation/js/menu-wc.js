                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/EmptyCartComponent.html" data-type="entity-link" >EmptyCartComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/SoldOutComponent.html" data-type="entity-link" >SoldOutComponent</a>
                            </li>
                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/checkResponse.html" data-type="entity-link" >checkResponse</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/ClearResponse.html" data-type="entity-link" >ClearResponse</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="interfaces/wishlistResponse.html" data-type="entity-link" >wishlistResponse</a>
                            </li>
                            <li class="link">
