...
import { CategoryRequest, CategoryRes, DeleteCategoryRes, SingleCategoryRes } from "../interfaces/categories.interface";
...
export abstract class CategoriesApi {
  ...
  abstract updateCategory(categoryId: string, categoryData: FormData): Observable<SingleCategoryRes>;
